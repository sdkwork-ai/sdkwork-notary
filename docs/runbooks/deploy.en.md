# Runbook — sdkwork-notary deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-notary-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-notary/bundle`, loads the image, starts
